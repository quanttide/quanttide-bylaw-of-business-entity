...
- connect/index.md：第十五条从"完整优先原则"改为"零理解负担原则"，包含三项可检验要求（没有事实错误、没有理解负担、无需多余修饰）；修正条号错乱问题（摘要/违规认定从内部沟通移至信息精炼义务章节）

## [0.7.4] - 2026-06-20

### Changed

- connect/index.md：大客户沟通规范改为适用所有外部人员，摘要规则移至内部沟通章节，章节重新编号

### Fixed

- connect/index.md：第十七条适用范围从"大客户"扩展为"所有外部人员"
...
- index.md：重写为完整的基本章程，新增法治优先、透明化、利他导向、自我进化四项基本原则；新增治理机构权力边界、法治体系层级、隐性经验显性化义务、信任与法治关系、制度自我进化等条款

## [0.7.1] - 2026-06-20

### Added

- qtcloud/share.md：新增第三章闭源资产保护（冰山之下资产定义、开源与非开源边界规则、护城河维护责任）；后续条款号顺延
- qtcloud/data.md：新增第六章跨领域边界（领域交叉识别、主从规则、争议解决）
- qtcloud/knowl.md：新增第六章跨领域边界（领域交叉识别、主从规则、争议解决）
...
- qtcloud/product.md：量潮云产品研发章程（档案建模、契约驱动、数据回写、验收标准）
- myst.yml：新增量潮云目录，注册 product.md
